...
try {
    ...
    $sql = 'SELECT P.firm, P.price_target, C.price, (((P.price_target-C.price)/C.price)*100) AS percent_difference FROM price_targets P, companies C ORDER BY percent_difference ASC';
    $q = $pdo->query($sql);
