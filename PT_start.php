        ...
        <div id="container">
                ...
                <br><h2>Insert a new price target:</h2>
                    <form action="/PT_insert.php" method="post">
                        <table>
                            ...
                            <tr><td>Prediction Date:</td><td><input type="text" id="Date" name="Date" value="?"></td></tr>
                        </table>
            ...
            <div id="Update">
                ...
                <form action="/PT_firm_update.php" method="post">
                    ...
                    <input type="submit" value="UPDATE_FIRM ">
                </form>
                <br>
                ...
                <form action="/PT_PT_update.php" method="post">
                    ...
                    <input type="submit" value="UPDATE_VALUE">
                </form>
                <br>
                ...
                <form action="/PT_Date_update.php" method="post">
                    <table>
                        <tr><td>Price Target ID:</td><td><input type="text" id="price_target_upDate" name="price_target_upDate" value="?"></td></tr>
                        <tr><td>New Date:</td><td><input type="text" id="upDate" name="upDate" value="?"></td></tr>
                    </table>
                    <input type="submit" value="UPDATE_DATE">
                </form>
                <br>
                <br><br><br>
            </div>
